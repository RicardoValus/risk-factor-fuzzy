Este projeto foi desenvolvido como parte do curso "Introdução à Inteligência Artificial". O objetivo é elaborar um fator de risco para incêndios florestais utilizando lógica fuzzy.
Objetivo
